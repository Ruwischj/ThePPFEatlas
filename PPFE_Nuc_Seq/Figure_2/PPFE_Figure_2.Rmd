...
```{r}
# Define DE Genes of interest for later Labeling in the Volcano Plot 
...
```{r}
# Secure DefaultAssay is switched to RNA
DefaultAssay(PPFE) <- "RNA"
PPFE <- subset(PPFE_mes, disease.ident != "IPF") # remove IPF 
...
# Aggregate Expression (Celllevel)
...
# Remove mitochondrial genes for clarity
...
temp <- subset(PPFE_mes,Celltype_ID_coarse_heat %in% c("Adventitial_Fb", "Adventitial_like_Fb","Subpleural_Fb", "CTHRC1_MyoFb"))
# Remove levels
